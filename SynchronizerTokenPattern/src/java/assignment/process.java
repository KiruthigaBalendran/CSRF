...
public class process extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("received token is " + receivedToken);
        ...
        System.out.println("sessionId for admin is " + sessionId);

        String token = sessionHandler.getCsrfTokenForSession(sessionId);
        System.out.println("csrfToken for sessionId is " + token);
